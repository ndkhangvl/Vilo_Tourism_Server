        ...
        <div class="navbar-nav-wrap">
            ...
            <div class="navbar-nav-wrap-content-right">
                ...
                <ul class="navbar-nav align-items-center flex-row">
                    <!-- Language for Travel Admin Dashboard -->
                    {{-- <li class="nav-item d-none d-sm-inline-block">
                            ...
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle "
                                ...
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate"></span>
                            </a>
            ...
            <div class="navbar-vertical-footer-offset">
                ...
                <div class="navbar-vertical-content">
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="nav-item">
                            <small class="nav-subtitle" title="Pages">Tin tức</small>
                            ...
                            <td class="text-center align-middle">{{ $vlplace->end_time }}</td> -->
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <a href="#" class="edit flex-grow-1" title="" data-toggle="tooltip"
                                        data-original-title="Edit" style="margin: 0 1px;"><i
                                    ...
                                    <form id="deleteForm-{{ $vlplace->id_place }}"
                                        ...
                                        <button type="submit" id="submitDel" class="btn btn-link p-0"
                                            style="margin: 0 1px;" data-toggle="tooltip"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title h4" id="addPlaceModal">Large modal</h5>
