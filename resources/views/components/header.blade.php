...
<div
    ...
    <div class="text-gray-100 text-xl">
        <div class="p-2.5 mt-1 flex items-center rounded-md ">
            ...
            <h1 class="text-[15px]  ml-3 text-xl text-gray-200 font-bold">ViloTourism</h1>
        ...
        px-4 duration-300 cursor-pointer  bg-gray-700">
            ...
            <div class="p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer  hover:bg-blue-600">
                ...
                <span class="text-[15px] ml-4 text-gray-200">Địa điểm</span>
            </div>
            <div class="p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer  hover:bg-blue-600">
                <i class="bi bi-bookmark-fill"></i>
                <span class="text-[15px] ml-4 text-gray-200">Tin tức</span>
            </div>
            <hr class="my-4 text-gray-600">
            <div class="p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer  hover:bg-blue-600">
                <i class="bi bi-envelope-fill"></i>
                <span class="text-[15px] ml-4 text-gray-200">Người dùng</span>
            </div>
            ...
            <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer  hover:bg-blue-600">
                ...
                <span class="text-[15px] ml-4 text-gray-200">Đăng xuất</span>
            </div>
