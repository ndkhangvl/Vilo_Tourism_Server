...
<head>
    ...
    <title>{{ trans('msg.list_news') }}</title>
</head>
...
<body>
    ...
    <div class="container md:pt-6 md:px-16 mx-auto sm:w-750 md:w-970 lg:w-1170 ">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="news p-2">
                <div class="flex justify-between items-end">
                    <h1 class="text-green-700 text-xl font-bold uppercase">{{ trans('msg.event') }}</h1>
                    <a href="/list-event"
            ...
            <div class="news p-2">
                <div class="flex justify-between items-end">
                    <h1 class="text-green-700 text-xl font-bold uppercase">{{ trans('msg.news') }}</h1>
                    <a href="/list-news"
                        class="text-gray-500 hover:text-blue-600 text-sm order-last">{{ trans('msg.view_more') }}</a>
                </div>
                <hr class="h-px my-2 bg-gray-200 border-0 dark:bg-gray-700">
        ...
        <div class="news p-2 mt-4">
            <div class="flex justify-between items-end">
                <h1 class="text-green-700 text-xl font-bold uppercase">{{ trans('msg.most_view_news') }}</h1>
                                    ...
                                    <div class="block w-full bg-opacity-50 text-black text-left">
                                        ...
                                        <div class="flex p-2">
                                            ...
                                            <h1 class="xl:text-sm max-sm:text-xs font-medium italic self-center">
                                                {{ trans('msg.view_news') }}: {{ $most_view_news->view_news }}
                                            </h1>
                                        </div>
                                        <div class="line-clamp-2 normal-case prose">
                                            <h1 class="xl:text-sm max-sm:text-xs text-justify">
